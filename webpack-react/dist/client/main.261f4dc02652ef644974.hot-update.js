...
eval("throw new Error(\"Module parse failed: Unexpected token (48:55)\\nFile was processed with these loaders:\\n * ./node_modules/ts-loader/index.js\\nYou may need an additional loader to handle the result of these loaders.\\n|             replies !== ''\\n|                 ? replies.data.children.map(function (item) { return (console.log(i)\\n>                     < Comment); }, key = { item: item, : .data.id }, author = { item: item, : .data.author }, date = { item: item, : .data.created }, body = { item: item, : .data.body }, replies = { item: item, : .data.replies }\\n|                     /  >\\n|                 ) : ,\");\n\n//# sourceURL=webpack:///./src/shared/CommentUsers/Comment/Comment.tsx?");
