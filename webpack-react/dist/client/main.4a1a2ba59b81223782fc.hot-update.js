...
eval("throw new Error(\"Module parse failed: Unexpected token (45:82)\\nFile was processed with these loaders:\\n * ./node_modules/ts-loader/index.js\\nYou may need an additional loader to handle the result of these loaders.\\n|             react_1.default.createElement(\\\"div\\\", null,\\n|                 react_1.default.createElement(\\\"h3\\\", null, body))),\\n>         react_1.default.createElement(\\\"div\\\", { className: comment_scss_1.default. }, replies !== ''\\n|             ? replies.data.children.map(function (item) { return (react_1.default.createElement(Comment, { key: item.data.id, author: item.data.author, date: item.data.created, body: item.data.body, replies: item.data.replies })); })\\n|             : react_1.default.createElement(react_1.default.Fragment, null))));\");\n\n//# sourceURL=webpack:///./src/shared/CommentUsers/Comment/Comment.tsx?");
