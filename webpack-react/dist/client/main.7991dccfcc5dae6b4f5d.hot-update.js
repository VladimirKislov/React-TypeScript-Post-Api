...
eval("throw new Error(\"Module parse failed: Unexpected token (56:134)\\nFile was processed with these loaders:\\n * ./node_modules/ts-loader/index.js\\nYou may need an additional loader to handle the result of these loaders.\\n|                 var newReplies = replies.data.children.filter(function (element) {\\n|                     if (element.data !== undefined)\\n>                         return true(react_1.default.createElement(Comment, { key: item.data.id, author: item.data.author, date: item. }));\\n|                 });\\n|             }) : )));\");\n\n//# sourceURL=webpack:///./src/shared/CommentUsers/Comment/Comment.tsx?");
