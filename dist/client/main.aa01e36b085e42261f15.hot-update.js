...
eval("throw new Error(\"Module parse failed: Unexpected token (12:210)\\nFile was processed with these loaders:\\n * ./node_modules/ts-loader/index.js\\nYou may need an additional loader to handle the result of these loaders.\\n| function UserBlock(_a) {\\n|     var avatarSrc = _a.avatarSrc, username = _a.username, loading = _a.loading;\\n>     return (react_1.default.createElement(\\\"a\\\", { href: \\\"https://www.reddit.com/api/v1/authorize?client_id=LTCW2f7TVj4zTVCfmNFpoA&response_type=code&state=random_string&redirect_uri=https://\\\".concat(process.env., \\\"/auth&scope=read submit identity\\\"), className: userblock_scss_1.default.userBox },\\n|         react_1.default.createElement(\\\"div\\\", { className: userblock_scss_1.default.avatarBox }, avatarSrc\\n|             ? react_1.default.createElement(\\\"img\\\", { src: avatarSrc, alt: \\\"user_avatar\\\", className: userblock_scss_1.default.avatarImage })\");\n\n//# sourceURL=webpack:///./src/shared/Header/SearchBlock/UserBlock/UserBlock.tsx?");
